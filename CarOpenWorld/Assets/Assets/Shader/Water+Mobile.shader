Shader "Water+/Mobile" {
	...
	SubShader {
		Tags { "FORCENOSHADOWCASTING" = "true" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Transparent-10" }
		Pass {
			Tags { "FORCENOSHADOWCASTING" = "true" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Transparent-10" }
			...
			Program "vp" {
				SubProgram "gles hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat10_4 = texture2D(_WaterMap, vs_TEXCOORD1.xy);
					    u_xlat16_24 = u_xlat10_4.w * 0.5;
					    u_xlat16_3.xyz = vec3(u_xlat16_24) * u_xlat16_3.xyz + u_xlat16_2.xyz;
					    u_xlat16_5.xyz = vec3(_DeepWaterTint.x, _DeepWaterTint.y, _DeepWaterTint.z) + (-_ShallowWaterTint.xyz);
					    u_xlat16_26 = u_xlat10_4.x * _WaterAttenuation;
					    u_xlat16_26 = clamp(u_xlat16_26, 0.0, 1.0);
					    u_xlat16_5.xyz = vec3(u_xlat16_26) * u_xlat16_5.xyz + _ShallowWaterTint.xyz;
					    ...
					    u_xlat16_5.xyz = vec3(u_xlat16_24) * vs_COLOR0.xyz;
					    u_xlat1.y = 1.0;
					    u_xlat16_24 = dot((-u_xlat16_5.xyz), u_xlat1.xyz);
					    u_xlat16_24 = u_xlat16_24 + u_xlat16_24;
					    u_xlat16_6.xyz = u_xlat1.xyz * (-vec3(u_xlat16_24)) + (-u_xlat16_5.xyz);
					    u_xlat10_0.xyw = textureCube(_Cube, u_xlat16_6.xyz).xyz;
					    u_xlat16_6.xyz = (-u_xlat16_3.xyz) + u_xlat10_0.xyw;
					    u_xlat16_3.xyz = vec3(vec3(_Reflectivity, _Reflectivity, _Reflectivity)) * u_xlat16_6.xyz + u_xlat16_3.xyz;
					    u_xlat16_6.xyz = u_xlat10_0.zzz + (-u_xlat16_3.xyz);
					    u_xlat16_24 = u_xlat10_4.y * _EdgeFoamStrength;
					    SV_Target0.w = u_xlat10_4.z * _Opaqueness;
					    u_xlat16_24 = u_xlat10_0.z * u_xlat16_24;
					    u_xlat16_24 = clamp(u_xlat16_24, 0.0, 1.0);
					    u_xlat16_3.xyz = vec3(u_xlat16_24) * u_xlat16_6.xyz + u_xlat16_3.xyz;
					    u_xlat16_24 = dot(u_xlat1.xyz, vs_TEXCOORD2.xyz);
					    ...
					    u_xlat16_6.y = dot(u_xlat16_5.xyz, u_xlat16_0.xyz);
					    u_xlat16_5.x = dot(u_xlat16_5.xyz, (-vs_TEXCOORD2.xyz));
					    u_xlat16_6.x = dot(vs_TEXCOORD2.xyz, u_xlat16_0.xyz);
					    u_xlat16_0.xy = u_xlat16_6.xy + vec2(1.0, 1.0);
					    u_xlat0.xy = u_xlat16_0.xy * vec2(0.5, 0.5);
					    u_xlat10_0.x = texture2D(_AnisoMap, u_xlat0.xy).w;
					    u_xlat16_12 = u_xlat10_0.x * _Gloss;
					    u_xlat16_24 = u_xlat16_24 * u_xlat16_12;
					    u_xlati0 = int((0.0<u_xlat16_5.x) ? -1 : 0);
					    u_xlati7 = int((u_xlat16_5.x<0.0) ? -1 : 0);
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat16_4 = texture(_WaterMap, vs_TEXCOORD1.xy);
					    u_xlat16_24 = u_xlat16_4.w * 0.5;
					    u_xlat16_3.xyz = vec3(u_xlat16_24) * u_xlat16_3.xyz + u_xlat16_2.xyz;
					    u_xlat16_5.xyz = vec3(_DeepWaterTint.x, _DeepWaterTint.y, _DeepWaterTint.z) + (-_ShallowWaterTint.xyz);
					    u_xlat16_26 = u_xlat16_4.x * _WaterAttenuation;
					    ...
					    u_xlat16_24 = u_xlat16_24 + u_xlat16_24;
					    u_xlat16_6.xyz = u_xlat1.xyz * (-vec3(u_xlat16_24)) + (-u_xlat16_5.xyz);
					    u_xlat16_0.xyw = texture(_Cube, u_xlat16_6.xyz).xyz;
					    u_xlat16_6.xyz = (-u_xlat16_3.xyz) + u_xlat16_0.xyw;
					    u_xlat16_3.xyz = vec3(vec3(_Reflectivity, _Reflectivity, _Reflectivity)) * u_xlat16_6.xyz + u_xlat16_3.xyz;
					    u_xlat16_6.xyz = u_xlat16_0.zzz + (-u_xlat16_3.xyz);
					    u_xlat16_24 = u_xlat16_4.y * _EdgeFoamStrength;
					    SV_Target0.w = u_xlat16_4.z * _Opaqueness;
					    u_xlat16_24 = u_xlat16_0.z * u_xlat16_24;
					#ifdef UNITY_ADRENO_ES3
					    ...
					    u_xlat16_12 = u_xlat16_0.x * _Gloss;
					    u_xlat16_24 = u_xlat16_24 * u_xlat16_12;
					#ifdef UNITY_ADRENO_ES3
					    { bool cond = 0.0<u_xlat16_5.x; u_xlati0 = int(!!cond ? 0xFFFFFFFFu : uint(0)); }
					#else
					    u_xlati0 = int((0.0<u_xlat16_5.x) ? 0xFFFFFFFFu : uint(0));
					#endif
					#ifdef UNITY_ADRENO_ES3
					    { bool cond = u_xlat16_5.x<0.0; u_xlati7 = int(!!cond ? 0xFFFFFFFFu : uint(0)); }
					#else
					    u_xlati7 = int((u_xlat16_5.x<0.0) ? 0xFFFFFFFFu : uint(0));
					#endif
					    u_xlati0 = (-u_xlati0) + u_xlati7;
					    u_xlat0.x = float(u_xlati0);
					    u_xlat0.x = max(u_xlat0.x, 0.0);
